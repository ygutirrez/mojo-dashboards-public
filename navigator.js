...
(function() {
    ...
    const DASHBOARDS = [
        ...
        { name: 'Technician Scorecard', url: 'https://mojo-technician-scorecard.mojoe-miami.workers.dev', icon: '🏅', category: 'Operations', keywords: 'technician annual performance review score percentile quality productivity manager private' },
